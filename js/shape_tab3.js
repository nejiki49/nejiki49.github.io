// $("#mypokename_tab3, #level_selection_tab3 input[name=Lv_tab3]").on("change", function () {
...
//   let shapeHtml = '<div id="pokeShape_tab3" class="cp_ipradio"><span class="moji">型</span><br>';
...
//   const shapeChange = document.getElementById('pokeShape_tab3');
//   shapeChange.innerHTML = shapeHtml;
// });
// $(document).on("change", "#mypokename_tab3, #pokeShape_tab3 input[name=shape_tab3], #level_selection_tab3 input[name=Lv_tab3]", function () {
...
//       <input type="radio" name="kota_tab3" id="kota1" value="0" checked>
//       <label for="kota1">0</label>
//       <input type="radio" name="kota_tab3" id="kota16" value="16">
//       <label for="kota16">16</label>
//       <input type="radio" name="kota_tab3" id="kota20" value="20">
//       <label for="kota20">20</label>
//       <input type="radio" name="kota_tab3" id="kota24" value="24">
//       <label for="kota24">24</label>
//       <input type="radio" name="kota_tab3" id="kota31" value="31">
//       <label for="kota31">31</label>
//     `;
//     }else if (mypokeBfNo >= 487 && mypokeBfNo <= 622) {
//       kotaChange.innerHTML = `
//       <input type="radio" name="kota_tab3" id="kota4" value="4" checked>
...
//       kotaChange.innerHTML = `
//         <input type="radio" name="kota_tab3" id="kota8" value="8" checked>
...
//       kotaChange.innerHTML = `
//       <input type="radio" name="kota_tab3" id="kota12" value="12" checked>
...
//     }else if (mypokeBfNo >= 487 && mypokeBfNo <= 622) {
//       kotaChange.innerHTML = `
//       <input type="radio" name="kota_tab3" id="kota16" value="16" checked>
//       <label for="kota16">16</label>
//       <input type="radio" name="kota_tab3" id="kota31" value="31">
//       <label for="kota31">31</label>
//     `;
//     }else if (mypokeBfNo >= 623 && mypokeBfNo <= 758) {
//       kotaChange.innerHTML = `
//         <input type="radio" name="kota_tab3" id="kota20" value="20" checked>
//         <label for="kota20">20</label>
//         <input type="radio" name="kota_tab3" id="kota31" value="31">
//         <label for="kota31">31</label>
//       `;
...
//       kotaChange.innerHTML = `
//       <input type="radio" name="kota_tab3" id="kota24" value="24" checked>
//       <label for="kota24">24</label>
//       <input type="radio" name="kota_tab3" id="kota31" value="31">
//       <label for="kota31">31</label>
//     `;
