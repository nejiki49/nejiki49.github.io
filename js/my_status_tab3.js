// kota_tab3、mypokename_tab3、shape、Lvのいずれかが変更されたときの処理
$("#kota_tab3, #mypokename_tab3, #pokeShape_tab3 input[name=shape_tab3], #level_selection_tab3 input[name=Lv_tab3]").on(
  "change",
  function () {
    // kotaのvalueを取得
    ...
    if (mypokeST) {
      ...
      const pokeStatus = document.getElementById("mypoke_status_tab3");
