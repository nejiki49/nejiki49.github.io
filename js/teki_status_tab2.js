// $("#kota_tab2, #tekipokename_tab2, #pokeShape_tab2 input[name=shape_tab2], #level_selection_tab2 input[name=Lv_tab2], #trainers_tab2").on("change", function () {
$(" #tekipokename_tab2,#level_selection_tab2 input[name=Lv_tab2], #trainers_tab2").on("change", function () {
  const trainersVal = parseFloat($("#trainers_tab2 option:selected").val());
  const tekipokeNameVal = parseFloat($("#tekipokename_tab2 option:selected").val());
  ...
  const trainerStatus = document.getElementById("trainer_status_tab2");
  ...
  if (
    ...
    const pokeStatus1 = document.getElementById("tekipoke_status1_tab2");
  ...
  if (
    ...
    const pokeStatus2 = document.getElementById("tekipoke_status2_tab2");
  ...
  if (
    ...
    const pokeStatus3 = document.getElementById("tekipoke_status3_tab2");
  ...
  if (
    ...
    const pokeStatus4 = document.getElementById("tekipoke_status4_tab2");
