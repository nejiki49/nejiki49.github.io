...
var tabs_new = function (tabs_id, opts) {
  ...
  function _debug(msg) {
    if (window.console && window.console.log) console.log("[debug] " + msg);
  }

  var $tabs, $tabsNav, $tabsNavItems, $tabsPanels;
  ...
  function _init(tabs_id, opts) {
    ...
    if ($("head #tabs-styles-default").length == 0) {
      ...
      if (bodyBackgroundColor === "rgba(0, 0, 0, 0)") bodyBackgroundColor = "white"; // standard white transparent background? use just white
