// $("#kota_tab3, #tekipokename_tab3, #pokeShape_tab3 input[name=shape_tab3], #level_selection_tab3 input[name=Lv_tab3], #trainers_tab3").on("change", function () {
$(" #tekipokename_tab3,#level_selection_tab3 input[name=Lv_tab3], #trainers_tab3").on("change", function () {
  ...
  const trainerStatus = document.getElementById("trainer_status_tab3");
  ...
  if (
    ...
    const pokeStatus1 = document.getElementById("tekipoke_status1_tab3");
  ...
  if (
    ...
    const pokeStatus2 = document.getElementById("tekipoke_status2_tab3");
  ...
  if (
    ...
    const pokeStatus3 = document.getElementById("tekipoke_status3_tab3");
  ...
  if (
    ...
    const pokeStatus4 = document.getElementById("tekipoke_status4_tab3");
